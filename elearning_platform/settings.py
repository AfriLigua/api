...
# Make sure STATICFILES_DIRS exists
STATICFILES_DIRS = [BASE_DIR / 'static'] if (BASE_DIR / 'static').exists() else []

# Add drf-spectacular-sidecar static files
STATICFILES_DIRS.append(str(Path(drf_spectacular_sidecar.__file__).parent / "static"))
...
CORS_ALLOWED_ORIGINS = config('CORS_ALLOWED_ORIGINS', default='http://localhost:8080,http://localhost:5000,https://frontend-mm2s.onrender.com', cast=Csv())
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'Production-ready Django REST Framework backend for an E-Learning Platform with role-based access, JWT authentication, course management, booking system, payment processing, messaging, and notifications.',
    'VERSION': '1.0.0',
    'SERVE_INCLUDE_SCHEMA': False,
